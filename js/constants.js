    ...
    templates: {
        settings: `<h2 id="h2CalcSettings">Einstellungen Taschenrechner</h2>
            <label class="left-aligned">
                <span id="lblButtons">Buttons</span>
                <input id="inpButtonStyle" type="range" class="slider" min="0" max="2" value="0">
                <span id="lblButtonStyle">eckig</span>
            </label>
            ...
            <label>
                <span id="lblDecimals">Dezimalstellen</span>
...
export const TMPL_PACKAGE_SIZE = `
    <div class="control" style="grid-column: 1 / span 4;">
        <label for="inpPackageSize" id="lblPackageSize" style="left: 0;">Platten / Pack</label>
        <input type="range" id="inpPackageSize" min="1" max="50" value="6" style="width: 5.5rem;">
        <span id="spnPackageSize" class="unit bags">6 pcs</span>
        <datalist id="lstPackageSize" hidden>
            <option>1</option>
            <option>2</option>
            <option>3</option>
